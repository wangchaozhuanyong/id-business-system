...
import '@/v2/styles/business-monitoring.css';
...
import V2BusinessMonitoringDesignFixture from './V2BusinessMonitoringDesignFixture.vue';

const app = createApp(V2BusinessMonitoringDesignFixture);
app.use(createPinia());
