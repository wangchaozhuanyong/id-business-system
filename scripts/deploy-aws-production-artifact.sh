...
RELEASE_MIGRATION_ARCHIVE=- RELEASE_MIGRATION_ARCHIVE_SHA256=- RELEASE_MIGRATION_SIZE_BYTES=- \
RELEASE_MEDIA_RESOLVER_ARCHIVE=- RELEASE_MEDIA_RESOLVER_ARCHIVE_SHA256=- RELEASE_MEDIA_RESOLVER_SIZE_BYTES=- \
RELEASE_RECHARGE_ARCHIVE=- RELEASE_RECHARGE_ARCHIVE_SHA256=- RELEASE_RECHARGE_SIZE_BYTES=- \
